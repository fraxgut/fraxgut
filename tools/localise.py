...
ES = [
 ...
 ('alt="GPG key', 'alt="Clave GPG'),
 ("## Support", "## Apoyo"),
 ("<summary>Stats</summary>", "<summary>Estadísticas</summary>"),
 ('alt="GitHub streak"', 'alt="Racha de GitHub"'),
 ('alt="GitHub contributions"', 'alt="Contribuciones de GitHub"'),
 ('alt="GitHub statistics"', 'alt="Estadísticas de GitHub"'),
 ('alt="Most-used languages"', 'alt="Lenguajes más usados"'),
 ('alt="GitHub activity"', 'alt="Actividad en GitHub"'),
...
LA = [
 ...
 ('aria-label="View ORCID record', 'aria-label="Vide tabulam ORCID'),
 ("Email is the best way to reach me. I answer as soon as I can.",
 ...
 ("## Support", "## Subsidium"),
 ("<summary>Stats</summary>", "<summary>Statistica</summary>"),
 ('alt="GitHub streak"', 'alt="Series GitHub"'),
 ('alt="GitHub contributions"', 'alt="Contributiones GitHub"'),
 ('alt="GitHub statistics"', 'alt="Statistica GitHub"'),
 ('alt="Most-used languages"', 'alt="Linguae maxime usitatae"'),
 ('alt="GitHub activity"', 'alt="Acta GitHub"'),
