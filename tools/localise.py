...
ES = [
 ...
 ('alt="GPG key', 'alt="Clave GPG'),
 ("## Support", "## Apoyo"),
 ("<summary><sub>Stats</sub></summary>", "<summary><sub>Estadísticas</sub></summary>"),
 ("label=Repositories", "label=Repositorios"),
 ("label=Followers", "label=Seguidores"),
 ("label=Stars", "label=Estrellas"),
 ('alt="Public repositories"', 'alt="Repositorios públicos"'),
 ('alt="GitHub followers"', 'alt="Seguidores en GitHub"'),
...
LA = [
 ...
 ("## Support", "## Subsidium"),
 ("<summary><sub>Stats</sub></summary>", "<summary><sub>Statistica</sub></summary>"),
 ("label=Repositories", "label=Repositoria"),
 ("label=Followers", "label=Sectatores"),
 ("label=Stars", "label=Stellae"),
 ('alt="Public repositories"', 'alt="Repositoria publica"'),
 ('alt="GitHub followers"', 'alt="Sectatores in GitHub"'),
